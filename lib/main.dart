...
import 'package:battery/battery.dart'; //IMPORTACIÓN
...
var battery = Battery();//SE NECESITA INSTANCIAR LA VARIABLE
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  subtitle: Row(
                    children: <Widget>[
                      Icon(Icons.touch_app, color: Colors.yellowAccent),
                      Text("Conocer la cantidad de bateria que tiene el dispositivo", style: TextStyle(color: Colors.white, fontSize: 12), )//SUBTEXTO QUE SE VA AMOSTRA
                    ],
                  ),
                  ...
                  onTap: ()async {
                    ...
                    //METODO QUE IMPRIME CUANTA BATERIA TIENE EL DISPOSITIVO
                  },
                ),
              ),
            ),
